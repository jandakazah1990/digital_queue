<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Pediatria.aspx.cs" Inherits="Digital_queue.Pediatria" %>
...
<body>
    <form id="form1" runat="server">
                <table style="width:100%">
                    <tr>
                         <td align="center" colspan="3"><asp:Label ID="lblHeader" runat="server" Font-Bold="True" Font-Size="XX-Large" ForeColor="#3366FF" Text="ОТДЕЛЕНИЕ ПЕДИАТРИИ"></asp:Label></td>                  
                    </tr>
                    <tr>
                        <td>
                             ...
                             <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                 <ContentTemplate>
                                     <asp:Label ID="lblShowMessage" runat="server" Font-Bold="True" Font-Size="Medium"></asp:Label>
                                      <asp:GridView ID="GridView1" Font-Bold="True" runat="server" BackColor="White" BorderColor="#DEDFDE" BorderStyle="Solid" BorderWidth="10px" CellPadding="4" Font-Size="100px" Width="100%" Height="100%" ForeColor="Black" GridLines="Vertical">
