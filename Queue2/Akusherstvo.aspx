...
<body>
    <form id="form1" runat="server">
                <table style="width:100%">
                    <tr>
                         <td align="center" colspan="3"><asp:Label ID="lblHeader" runat="server" Font-Bold="True" Font-Size="XX-Large" ForeColor="#3366FF" Text="ОТДЕЛЕНИЕ ЖЕНСКОГО ЗДОРОВЬЯ"></asp:Label></td>                  
                    </tr>
                    <tr>
