...
<body>
    <form id="form1" runat="server" style="height=100%">
        <table style="width:100%;">
            ...
            <tr>
                <td>
                    <asp:Button ID="btnPediatria" runat="server" Font-Bold="True" Font-Size="Medium" Height="35px" Text="Монитор Педиатрии" Width="237px" BackColor="White" OnClick="btnPediatria_Click" Visible="False" />
                   </td>
                <td>
                </td>
                <td></td>
            ...
            <tr>
                <td class="auto-style3">
                    <asp:Button ID="btnAkusherstvo" runat="server" Font-Bold="True" Font-Size="Medium" Height="35px" Text="Монитор Женского Здоровья" Width="238px" BackColor="White" OnClick="btnAkusherstvo_Click" />
                </td>
                <td>
                    &nbsp;</td>
                <td> &nbsp;</td>
